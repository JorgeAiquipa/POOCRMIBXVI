...
public class VentaManager {
    ...
    public VentaManager(String tipo, String concepto, String numero, String fec_emision, String empresa, double subtotal, double igv, double total, String moneda, String fec_venc, String fec_pago, String estado, String observaciones){
        this.tipo = tipo;
